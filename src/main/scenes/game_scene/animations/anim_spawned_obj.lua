...
local SpawnedObjectAnimations = {}

function SpawnedObjectAnimations:animate_scale()
...
function SpawnedObjectAnimations:animate_rotation()
...
return SpawnedObjectAnimations
